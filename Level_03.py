...
class Card:
    ...
    Color_Set = [(random.choice(RGB)),(random.choice(RGB)),(random.choice(RGB)),(random.choice(RGB)),(random.choice(RGB))]
...
def level_03():
    ...
    for i in range(20):
        Card_Set.append(Card((0, 255, 0), pos_x[card_x], pos_y[card_y], 85, 130,pair_set))
        card_x += 1
        if (card_x > 4):
            card_x = 0
            card_y += 1
        ...
        for card in Card_Set:
            if card.selected == False:
                ...
                if card.isOver(pos):
                    ...
                    card.draw(screen)
                    if (mb[0]):
                        print("Last Card Clicked: Shape:" + str(card_shape) + " , Pair:"+ str(card.pair))
